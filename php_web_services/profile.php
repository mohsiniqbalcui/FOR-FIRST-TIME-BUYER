          ...
          <div class="section">
            <div class="section-body">
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="fileupload_block">
                    <input type="file" name="image" id="fileupload" onchange="return fileValidation()">
                    <?php if($row['image']!="") {?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <input type="password" name="password" id="password" value="<?php echo $row['password'];?>" class="form-control" autocomplete="off">
                </div>
              </div>
              <div class="form-group">

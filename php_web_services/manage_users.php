...
if(isset($_POST['user_search']))
{
	...
	$user_qry="SELECT * FROM tbl_users WHERE tbl_users.`name` LIKE '%$searchinput%' OR tbl_users.`email` LIKE '%$searchinput%' OR tbl_users.`device_id` LIKE '%$searchinput%' ORDER BY tbl_users.`id` DESC";  
          ...
          if(mysqli_num_rows($users_result) > 0)
              ...
              <tr <?php if($users_row['is_duplicate']==1){ echo 'style="background-color: rgba(255,0,0,0.1);"'; } ?>>
                ...
                <td>
                  ...
                  <a href="add_user.php?user_id=<?php echo $users_row['id']; ?>&action=edit&redirect=<?=$redirectUrl?>" class="btn btn-primary btn_cust" data-toggle="tooltip" data-tooltip="Edit"><i class="fa fa-edit"></i></a>

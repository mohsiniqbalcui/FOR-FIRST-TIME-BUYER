...
$total_category = $total_category['num'];
  ...
  // Get rooms
$qry_rooms="SELECT COUNT(*) as num FROM tbl_rooms";
$total_rooms= mysqli_fetch_array(mysqli_query($mysqli,$qry_rooms));
$total_rooms = $total_rooms['num'];

  // Get wallpaper
$qry_gallery="SELECT COUNT(*) as num FROM tbl_wallpaper";
$total_gallery = mysqli_fetch_array(mysqli_query($mysqli,$qry_gallery));
$total_gallery = $total_gallery['num'];

  // Get home banner
$qry_banner="SELECT COUNT(*) as num FROM tbl_home_banner";
  ...
  <!-- Smtp Config end -->
    <div class="row">
     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> <a href="manage_category.php" class="card card-banner card-green-light">
      ...
      <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> <a href="manage_rooms.php" class="card card-banner card-pink-light">
        <div class="card-body"> <i class="icon fa fa-hotel fa-4x"></i>
          <div class="content">
            <div class="title">Rooms</div>
            <div class="value"><span class="sign"></span><?php echo $total_rooms;?></div>
          </div>
        </div>
        </a> 
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> <a href="manage_gallery.php" class="card card-banner card-yellow-light">
        <div class="card-body"> <i class="icon fa fa-image fa-4x"></i>
          <div class="content">
            <div class="title">Gallery</div>
            <div class="value"><span class="sign"></span><?php echo $total_gallery;?></div>
          </div>
        </div>
        </a> 
        </div>
        <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> <a href="manage_home_banner.php" class="card card-banner card-blue-light">
